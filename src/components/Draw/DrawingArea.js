...
const DrawingArea = () => {
  ...
  const onResize = (event, size, index) => {
            ...
            <Layer>
              ...
              {rectangles.map((rectangle, i) => (
                <Resizable
                  ...
                  onResize={(e, { size }) => onResize(e, size, i)}
                // minConstraints={[100, 100]} // Set minimum size constraints
                // maxConstraints={[400, 400]} // Set maximum size constraints
                >
                  <Rect
                    key={i}
                    x={rectangle.x}
